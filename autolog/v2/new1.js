// This code uses the puppeteer package, which can automatically use the system's default Chrome installation. It simplifies the launch configuration and should work as expected without needing to specify the executablePath.
